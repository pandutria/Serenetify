...
class RecoveryPlan5Activity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_recovery_plan5)
        ...
        btnNext.setOnClickListener {
            if (cb1.isChecked && cb2.isChecked && cb3.isChecked && cb4.isChecked && cb5.isChecked) {
                val intent = Intent(this, RecoveryPlanDoneActivity::class.java)
